...
typedef enum
{
	...
	AGGREGATE_TDIGEST_PERCENTILE_OF_ADD_DOUBLE = 25,
	AGGREGATE_TDIGEST_PERCENTILE_OF_ADD_DOUBLEARRAY = 26,

	/* AGGREGATE_CUSTOM must come last */
	AGGREGATE_CUSTOM_COMBINE = 27,
	AGGREGATE_CUSTOM_ROW_GATHER = 28,
} AggregateType;

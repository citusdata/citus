...
/* cache operations */
extern PreparedStatementCacheEntry * PreparedStatementCacheLookup(
	HTAB *cache, uint32 planId, uint64 shardId);
extern PreparedStatementCacheEntry * PreparedStatementCacheInsert(
	HTAB *cache, uint32 planId, uint64 shardId);

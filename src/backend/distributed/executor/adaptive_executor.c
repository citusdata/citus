 ...
 *
 * You can see the current lock rules in
 * src/backend/distributed/executor/CitusExecutorLockMap.pdf and
 * the corresponding rules in
 * src/backend/distributed/executor/CitusExecutorLockMap.txt. You
 * can use Powerpoint's SmartArt feature to generate the pdf again.
 */
static void

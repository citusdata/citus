			 ...
			 bool suppressNoticeMessages)
{
	 ...
	 * Since renaming an identity with DDL_PROPAGATION_ENABLED causes conflicts on worker nodes,
	 * so we have two seperated list of commands to run on coordinator and workers.
	 */
	...
	/*
	 * We have to mark identity sequences generated by PG explicitly
	 */

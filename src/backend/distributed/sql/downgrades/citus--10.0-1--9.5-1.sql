...
DROP FUNCTION pg_catalog.worker_hash_partition_table_v2(bigint, integer, text, integer, oid, anyarray);
DROP FUNCTION pg_catalog.worker_range_partition_table_v2(bigint, integer, text, integer, oid, anyarray);

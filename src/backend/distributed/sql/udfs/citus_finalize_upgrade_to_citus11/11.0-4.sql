...
CREATE OR REPLACE PROCEDURE pg_catalog.citus_finalize_upgrade_to_citus11(enforce_version_check bool default true)
  LANGUAGE plpgsql
  AS $$
BEGIN
...
END;
$$;
COMMENT ON PROCEDURE pg_catalog.citus_finalize_upgrade_to_citus11(bool)
  IS 'finalizes upgrade to Citus';

REVOKE ALL ON PROCEDURE pg_catalog.citus_finalize_upgrade_to_citus11(bool) FROM PUBLIC;

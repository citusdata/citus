...
\set array_types_csv_file :abs_srcdir '/data/array_types_csv_file'
...
\set datetime_types_csv_file :abs_srcdir '/data/datetime_types_csv_file'
...
\set enum_and_composite_types_csv_file :abs_srcdir '/data/enum_and_composite_types_csv_file'
...
\set range_types_csv_file :abs_srcdir '/data/range_types_csv_file'
...
\set other_types_csv_file :abs_srcdir '/data/other_types_csv_file'
...
\set null_values_csv_file :abs_srcdir '/data/null_values_csv_file'

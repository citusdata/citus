CREATE SCHEMA view_acceess_method_test;
SET search_path TO view_acceess_method_test;
...
SELECT create_distributed_table('view_acceess_method_test.view_test_table','id');
...
--clean environment
DROP SCHEMA view_acceess_method_test CASCADE;

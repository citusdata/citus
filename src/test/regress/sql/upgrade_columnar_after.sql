...
-- since we run "after schedule" twice, truncate tables to
-- avoid getting duplicate key errors
TRUNCATE less_common_data_types_table, columnar_with_constraints, text_data;

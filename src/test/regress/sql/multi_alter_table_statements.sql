...
CREATE TABLE range_default_expr_table(c0 int, c1 boolean);
SELECT create_distributed_table('range_default_expr_table', 'c0');
ALTER TABLE range_default_expr_table
	ALTER c1 SET DEFAULT (NOT ((((('[-1,-1]'::int4range) * ('[1,1]'::int4range))) >
							 ((('[-2,-2)'::int4range) * ('[2,2)'::int4range)))))) IS TRUE;

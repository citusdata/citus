...
-- test EXPLAIN
EXPLAIN (COSTS FALSE, BUFFERS OFF) INSERT INTO non_dist_1 SELECT * FROM dist_table;
EXPLAIN (COSTS FALSE, BUFFERS OFF) INSERT INTO non_dist_1 SELECT * FROM dist_table WHERE a = 1;

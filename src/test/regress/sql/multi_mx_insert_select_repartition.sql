...
EXPLAIN (costs off, BUFFERS OFF) INSERT INTO target_table(a) SELECT square(4);
...
\c - - - :worker_1_port
SET search_path TO multi_mx_insert_select_repartition;
EXPLAIN (costs off, BUFFERS OFF) INSERT INTO target_table SELECT a, max(b) FROM source_table GROUP BY a;

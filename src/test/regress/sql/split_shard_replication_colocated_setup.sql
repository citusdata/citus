...
SELECT count(*) FROM pg_catalog.worker_split_shard_replication_setup(ARRAY[
    ROW(4, 'id', 5, '-2147483648', '-1', :worker_2_node, 0)::pg_catalog.split_shard_info,
    ROW(4, 'id', 6, '0', '2147483647', :worker_2_node, 0)::pg_catalog.split_shard_info,
    ROW(7, 'id', 8, '-2147483648', '-1', :worker_2_node, 0)::pg_catalog.split_shard_info,
    ROW(7, 'id', 9, '0', '2147483647', :worker_2_node, 0)::pg_catalog.split_shard_info
    ]);

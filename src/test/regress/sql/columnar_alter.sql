...
-- Add a UNIQUE constraint (should ok)
CREATE TABLE products_ok1 (
...
-- Add a PRIMARY KEY constraint (should ok)
CREATE TABLE products_ok2 (
    product_no integer PRIMARY KEY,
    name text,
    price numeric
) USING columnar;

-- Add an EXCLUSION constraint (should ok)

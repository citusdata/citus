...
EXPLAIN (COSTS OFF, BUFFERS OFF) SELECT * FROM distributed_table WHERE key = 1 AND age = 20;
...
EXPLAIN (COSTS OFF, BUFFERS OFF) DELETE FROM distributed_table WHERE key = 1 AND age = 20;

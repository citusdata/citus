...
SET citus.log_remote_commands TO on;
EXPLAIN (GENERIC_PLAN, BUFFERS OFF) SELECT unique1 FROM tenk1 WHERE thousand = $1;
EXPLAIN (GENERIC_PLAN, ANALYZE, BUFFERS OFF) SELECT unique1 FROM tenk1 WHERE thousand = $1;
SET citus.log_remote_commands TO off;

...
-- Step 1.3: Add exclusion constraints on long name partition
ALTER TABLE AT_AddConstNoName.longlonglonglonglonglonglonglonglonglonglonglonglonglonglongabc ADD CONSTRAINT long_name_exclude EXCLUDE USING btree (dist_col WITH =);

-- Verify the constraint was added
SELECT conname FROM pg_constraint WHERE conrelid = 'AT_AddConstNoName.longlonglonglonglonglonglonglonglonglonglonglonglonglonglongabc'::regclass AND conname = 'long_name_exclude';

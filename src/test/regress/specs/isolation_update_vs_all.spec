...
# session 1
session "s1"
step "s1-initialize" { INSERT INTO update_hash VALUES (0, 'a'), (1, 'b'), (2, 'c'), (3, 'd'), (4, 'e'); }
step "s1-begin" { BEGIN; }
...
step "s1-create-non-distributed-table" { CREATE TABLE update_hash(id integer, data text); INSERT INTO update_hash VALUES (0, 'a'), (1, 'b'), (2, 'c'), (3, 'd'), (4, 'e'); }

...
# session 1
session "s1"
step "s1-initialize" { INSERT INTO delete_hash VALUES (0, 'a'), (1, 'b'), (2, 'c'), (3, 'd'), (4, 'e'); }
step "s1-begin" { BEGIN; }
...
step "s1-create-non-distributed-table" { CREATE TABLE delete_hash(id integer, data text); INSERT INTO delete_hash VALUES (0, 'a'), (1, 'b'), (2, 'c'), (3, 'd'), (4, 'e'); }
...
step "s2-create-non-distributed-table" { CREATE TABLE delete_hash(id integer, data text); INSERT INTO delete_hash VALUES (0, 'a'), (1, 'b'), (2, 'c'), (3, 'd'), (4, 'e'); }

...
# session 1
session "s1"
step "s1-initialize" { COPY append_copy FROM PROGRAM 'echo 0, a, 0:1, b, 1:2, c, 2:3, d, 3:4, e, 4 | tr : "\n"' WITH CSV; }
step "s1-begin" { BEGIN; }
step "s1-copy" { COPY append_copy FROM PROGRAM 'echo 5, f, 5:6, g, 6:7, h, 7:8, i, 8:9, j, 9 | tr : "\n"' WITH CSV; }
step "s1-copy-additional-column" { COPY append_copy FROM PROGRAM 'echo 5, f, 5, 5:6, g, 6, 6:7, h, 7, 7:8, i, 8, 8:9, j, 9, 9 | tr : "\n"' WITH CSV; }
...
# session 2
session "s2"
step "s2-copy" { COPY append_copy FROM PROGRAM 'echo 5, f, 5:6, g, 6:7, h, 7:8, i, 8:9, j, 9 | tr : "\n"' WITH CSV; }
step "s2-copy-additional-column" { COPY append_copy FROM PROGRAM 'echo 5, f, 5, 5:6, g, 6, 6:7, h, 7, 7:8, i, 8, 8:9, j, 9, 9 | tr : "\n"' WITH CSV; }
